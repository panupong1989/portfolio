...
const Project = ({
    ...
    return (
        <div
            ...
            className="project-item group leading-none py-5 md:border-b first:!pt-0 last:pb-0 last:border-none md:group-hover/projects:opacity-60 md:hover:!opacity-100 transition-all cursor-pointer"
